...
function getPedidosByIds($pdo, $ids) {
	...
	$pdoConnection = require_once "db.class.php";
...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(img/heading/fastfood.jpg);">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<?php
						...
						$pedidos = $pdo->select("SELECT * FROM pedidos WHERE id_cat='1'");
